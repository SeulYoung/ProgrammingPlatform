 ...
 * {@link Blog.OnFragmentInteractionListener} interface
...
public class Blog extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        item.add("Sport:yogadsuialisudhvliuashdlivuhasliduhvliasudhviausdhvliausdhfvoiaudhvasbdvaisdb");
        ...
        picture.add(R.drawable.blog);
        picture.add(R.drawable.forum);
        picture.add(R.drawable.live);
        picture.add(R.drawable.question);
        picture.add(R.drawable.blog);
        picture.add(R.drawable.live);
        ...
        mAdapter = new BlogAdapter(name,item,picture,a,a,a, R.layout.blogitem,this.getActivity());

        mAdapter.setOnItemClickListener(new BlogAdapter.OnItemClickListener() {
            @Override
