...
//    private ImageReader mImageReader            = null;
    ...
    public void setContentView() {
        ...
        mPushVisibleLogView = (TXPushVisibleLogView) findViewById(R.id.visibleLogView);
        //log部分
        final Button btnLog = (Button) findViewById(R.id.btnLog);
        btnLog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mPushVisibleLogView.show(false);
                mPushVisibleLogView.countUp();
                int count = mPushVisibleLogView.getCount() % 3;
                if (count == 0) {
                    btnLog.setBackgroundResource(R.drawable.log_hidden);
                    mCaptureView.showLog(true);
                } else if (count == 1) {
                    btnLog.setBackgroundResource(R.drawable.log_hidden);
                    mPushVisibleLogView.show(true);
...
//        }
    ...
    public void onNetStatus(Bundle status) {
        ...
        mPushVisibleLogView.setLogText(status, null, 0);
//        if (mLivePusher != null){
                            ...
                            pusher.mMainHandler.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (TextUtils.isEmpty(pushUrl)) {
                                        ...
                                        Bundle params = new Bundle();
                                        params.putString(TXLiveConstants.EVT_DESCRIPTION, "检查地址合法性");
                                        pusher.mPushVisibleLogView.setLogText(null, params, TXPushVisibleLogView.CHECK_RTMP_URL_OK);
